...
async function enableTeacherNotifications(){
 ...
 alert(p==='granted'?'Notificaciones activadas.':'No se concedió permiso para notificaciones.');
}
...
async function replyStudentMessage(id){
 ...
 try{
   ...
   m.reply=reply;m.repliedAt=repliedAt;m.status='replied';m.teacherRead=true;m.unread=false;
