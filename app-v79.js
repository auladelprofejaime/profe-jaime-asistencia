...
function remoteActivity(a){return {id:String(a.id),group_name:a.group||'',shift:a.shift||'',title:a.name||'Actividad',activity_date:a.date||null,evaluation_type:a.evaluationMode||'delivery',max_score:10,visible_to_students:true,closed:!!a.closed,data:a}}
