...
// ===== Mérito Gabino A. Palma · ajustes administrativos v8.16.0 =====
...
// ===== MÉRITO GABINO A. PALMA · CIERRE FINAL v8.16.0 =====
const meritCriterionLabels={
...
async function loadMeritMonthlyPreview(){
 ...
 if(!period){$('#meritMonthlyPreview').innerHTML='<p class="hint">Selecciona un periodo.</p>';return}
 try{
   ...
   $('#meritMonthlyStatus').textContent=p.has_ties?'Hay empates que deben resolverse antes de cerrar.':'Vista previa lista para cierre.';
 }catch(e){$('#meritMonthlyStatus').textContent='No se pudo generar la vista previa: '+(e.message||e)}
}
...
document.addEventListener('DOMContentLoaded',()=>{
 $('#meritMonthlyPreviewBtn')&&($('#meritMonthlyPreviewBtn').onclick=loadMeritMonthlyPreview);
 $('#meritMonthlyCloseBtn')&&($('#meritMonthlyCloseBtn').onclick=closeMeritMonth);
 $('#meritMonthlyPublishBtn')&&($('#meritMonthlyPublishBtn').onclick=publishMeritMonth);
 ...
 $('#meritAnnualRefresh')&&($('#meritAnnualRefresh').onclick=loadMeritAnnualRanking);
