   ...
   box.innerHTML=scheduleCache
     ...
     .map(x=>`<div class="row">
       <div>
         ...
         <small>${safe(x.shift)} · ${safe(x.group_name)} · ${safe(x.subject)} · aviso ${safe(x.reminder_minutes)} min antes${x.enabled?'':' · DESACTIVADO'}</small>
       </div>
