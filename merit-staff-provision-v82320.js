// App Docente v8.23.20 · Gestión de docentes de Mérito
(function(){
  ...
  async function buildTeacherAccessPdf(credentials){
    ...
    function card(item,slot){
      ...
      const bx=cardX+66,by=cardY+94,bw=cardW-132,bh=39;
      drawCode39Pdf(doc,code,bx,by,bw,bh);
      doc.setFont('helvetica','normal');doc.setFontSize(8);doc.setTextColor(30,30,30);
      doc.text(code,cardX+cardW/2,by+51,{align:'center'});
      ...
      doc.text(doc.splitTextToSize(msg,noteW-24),noteX+12,noteY+34,{lineHeightFactor:1.15});
  ...
  async function printTeacherFolios(){
    ...
    finally{if(btn){btn.disabled=false;btn.textContent=old||'Generar PDF · 60 accesos'}}
  }
