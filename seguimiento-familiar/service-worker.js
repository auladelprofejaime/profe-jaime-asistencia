...
const FILES=['./','./index.html','./styles.css','./app-v8133.js','./manifest.webmanifest','./profe-jaime.png','./icon-app-padres-v821.png','../shared/data-contract.js','../shared/supabase-adapter.js'];
