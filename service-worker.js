const CACHE='app-docente-v8-23-23';
const APP_CACHE_PREFIX='app-docente-';
const ROOT_PATH=new URL('./',self.location.href).pathname;
const LOCAL=[
 './','./index.html','./styles.css','./app-v82312.js?v=82312','./merit-period-fix-v82321.js?v=82321','./merit-schoolwide-fix-v82314.js?v=82314','./merit-staff-provision-v82322.js?v=82322','./merit-tie-vote-v82323.js?v=82323',
